  ...
  methods: {
    ...
    async initializePayment() {
      try {
        ...
        const response = await axios.post(
          "https://event-ticket-backend-gnmw.onrender.com/api/initialize",
          {
            email: this.email,
            amount: this.amount,
          }
    ...
    async getTicket() {
      try {
        ...
        const res = await axios.post(
          "https://event-ticket-backend-gnmw.onrender.com/api/order",
          payload
        );
        this.spinner = false; // Hide spinner after processing
    ...
    async applyPromo() {
      try {
        ...
        const res = await axios.post(
          "https://event-ticket-backend-gnmw.onrender.com/api/apply-promo",
          payload
        );
